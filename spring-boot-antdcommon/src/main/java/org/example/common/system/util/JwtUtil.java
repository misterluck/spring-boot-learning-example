package org.example.common.system.util;
...
import org.example.common.constant.DataBaseConstant;
import org.example.common.exception.CustomBootException;
import org.example.common.system.vo.LoginUser;
import org.example.common.system.vo.SysUserCacheInfo;
import org.example.common.util.SpringContextUtils;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws CustomBootException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws CustomBootException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new CustomBootException("未获取到用户");
		}
		return username;
	}
